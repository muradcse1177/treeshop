            ...
            <div class="col-lg-4">
                ...
                <div class="product-offer">
                    ...
                    <div class="product-offer-active">
                        @foreach($data['product']['dayOfDay'] as $dayOfDay)
                        <div class="single-product">
                            <div class="product-img img-full">
                                <a href="single-product.html">
                                    <img src="{{$dayOfDay->feature_image}}" alt="">
                                </a>
                            ...
                            <div class="product-content">
                                <h2><a href="single-product.html">{{$dayOfDay->name}}</a></h2>
                                <div class="product-price">
                                    <div class="price-box">
                                        <span class="regular-price">{{'৳'." ".$dayOfDay->price}}</span>
                                    </div>
