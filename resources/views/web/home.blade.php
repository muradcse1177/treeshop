...
<!-- Mirrored from d29u17ylf1ylz9.cloudfront.net/plantmore-v3/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Aug 2018 17:24:13 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Home-5 || Plantmore</title>
    ...
    <!-- Linearicon CSS-->
    <link rel="stylesheet" href="/web/css/linearicons.min.css">
    <!-- Font Awesome CSS-->
    ...
    <!-- Easyzoom CSS-->
    <link rel="stylesheet" href="/web/css/easyzoom.css">
    <!-- Venobox CSS-->
    <link rel="stylesheet" href="/web/css/venobox.css">
    <!-- Jquery Ui CSS-->
                    ...
                    <div class="hero-slider hero-slider-5 owl-carousel">
                        ...
                        <div class="single-slider-style-5" style="background-image: url(img/slider/home5-slider1.jpg)">
                            ...
                            <div class="hero-slider-content hero-slider-content-5">
                                <img class="first-img" src="/web/img/slider/home5-slider1-text1.png" alt="">
                                <img class="secound-img" src="/web/img/slider/home5-slider1-icon.png" alt="">
                            </div>
                        </div>
                        <!--Single Slider End-->
                        <!--Single Slider Start-->
                        <div class="single-slider-style-5" style="background-image: url(img/slider/home5-slider2.jpg)">
                            ...
                            <div class="hero-slider-content hero-slider-content-6">
                                <img class="first-img" src="/web/img/slider/home5-slider2-text.png" alt="">
                                <img class="secound-img" src="/web/img/slider/home5-slider2-icon.png" alt="">
                            </div>
                        </div>
                        <!--Single Slider End-->
                    </div>
                    ...
                    <div class="product-offer">
                        ...
                        <div class="product-offer-active">
                            ...
                            <div class="single-product">
                                <div class="product-img img-full">
                                    <a href="single-product.html">
                                        <img src="/web/img/product/product12.jpg" alt="">
                                    </a>
                            ...
                            <div class="single-product">
                                <div class="product-img img-full">
                                    <a href="single-product.html">
                                        <img src="/web/img/product/product11.jpg" alt="">
                                    </a>
                                    <span class="onsale">Sale!</span>
                                    <div class="product-action">
                                        <ul>
                            ...
                            <div class="single-product">
                                <div class="product-img img-full">
                                    <a href="single-product.html">
                                        <img src="/web/img/product/product10.jpg" alt="">
                                    </a>
                                    <span class="onsale">Sale!</span>
                                    <div class="product-action">
                                        <ul>
                            ...
                            <div class="single-product">
                                <div class="product-img img-full">
                                    <a href="single-product.html">
                                        <img src="/web/img/product/product9.jpg" alt="">
                                    </a>
                                    <span class="onsale">Sale!</span>
                                    <div class="product-action">
                                        <ul>
                            ...
                            <div class="sidebar-product-active">
                                <div class="product-item">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product6.jpg" alt=""></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product11.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product19.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product14.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product23.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product22.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product16.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product13.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                                    ...
                                    <div class="single-product product-list">
                                        <div class="list-col-4">
                                            <div class="product-img img-full">
                                                <a href="single-product.html"><img src="/web/img/product/product10.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="list-col-8">
                                            <div class="product-content">
                    ...
                    <div class="sidebar-layout mb-35">
                        <div class="sidebar-banner single-banner">
                            <div class="banner-img">
                                <a href="#"><img src="/web/img/banner/shop-sidebar.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="single-banner mb-35">
                                        <div class="banner-img">
                                            <a href="#">
                                                <img src="/web/img/banner/banner6.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="single-banner mb-35">
                                        <div class="banner-img">
                                            <a href="#">
                                                <img src="/web/img/banner/banner7.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <!--Single Banner Area End-->
                                                ...
                                                <div class="store-slider-active">
                                                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product1.jpg" alt="">
                                                                </a>
                                                                <span class="onsale">Sale!</span>
                                                                <div class="product-action">
                                                                    <ul>
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product2.jpg" alt="">
                                                                </a>
                                                                <div class="product-action">
                                                                    <ul>
                                                                        <li><a href="#open-modal" data-toggle="modal" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product3.jpg" alt="">
                                                                </a>
                                                                <div class="product-action">
                                                                    <ul>
                                                                        <li><a href="#open-modal" data-toggle="modal" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product4.jpg" alt="">
                                                                </a>
                                                                <div class="product-action">
                                                                    <ul>
                                                                        <li><a href="#open-modal" data-toggle="modal" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product5.jpg" alt="">
                                                                </a>
                                                                <div class="product-action">
                                                                    <ul>
                                                                        <li><a href="#open-modal" data-toggle="modal" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product6.jpg" alt="">
                                                                </a>
                                                                <div class="product-action">
                                                                    <ul>
                                                                        <li><a href="#open-modal" data-toggle="modal" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product7.jpg" alt="">
                                                                </a>
                                                                <div class="product-action">
                                                                    <ul>
                                                                        <li><a href="#open-modal" data-toggle="modal" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                        ...
                                                        <div class="single-product mb-25">
                                                            <div class="product-img img-full">
                                                                <a href="single-product.html">
                                                                    <img src="/web/img/product/product8.jpg" alt="">
                                                                </a>
                                                                <div class="product-action">
                                                                    <ul>
                                                                        <li><a href="#open-modal" data-toggle="modal" title="Quick view"><i class="fa fa-search"></i></a></li>
                                ...
                                <div class="product-list-slider-active2">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product5.jpg" alt=""></a>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                            <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product15.jpg" alt=""></a>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                            <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product8.jpg" alt=""></a>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                            <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product20.jpg" alt=""></a>
                                                    <span class="onsale">Sale!</span>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product18.jpg" alt=""></a>
                                                    <span class="onsale">Sale!</span>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product17.jpg" alt=""></a>
                                                    <span class="onsale">Sale!</span>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product2.jpg" alt=""></a>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                            <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
                                        ...
                                        <div class="single-product product-list mb-35">
                                            <div class="list-col-4">
                                                <div class="product-img img-full">
                                                    <a href="single-product.html"><img src="/web/img/product/product4.jpg" alt=""></a>
                                                    <span class="onsale">Sale!</span>
                                                    <div class="product-action">
                                                        <ul>
                                                            <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                ...
                <div class="blog-slider-active">
                    <div class="col-md-4">
                        ...
                        <div class="single-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <p class="post-author">
                                    <img src="/web/img/icon/author.png" alt=""> <span>Posted by </span>
                                    <a href="#">admin </a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="single-blog">
                            <div class="blog-img img-full">
                                <a href="single-blog.html">
                                    <img src="/web/img/blog/blog3.jpg" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="post-date">01/12/2018</div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="single-blog">
                            <div class="blog-img img-full">
                                <a href="single-blog.html">
                                    <img src="/web/img/blog/blog4.jpg" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="post-date">01/12/2018</div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="single-blog">
                            <div class="blog-img img-full">
                                <a href="single-blog.html">
                                    <img src="/web/img/blog/blog5.jpg" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="post-date">01/12/2018</div>
                ...
                <div class="col-12">
                    <div class="brand-active">
                        ...
                        <div class="single-brand img-full">
                            <a href="#"><img src="/web/img/brand/brand1.png" alt=""></a>
                        </div>
                        <!--Single Brand End-->
                        <!--Single Brand Start-->
                        <div class="single-brand img-full">
                            <a href="#"><img src="/web/img/brand/brand2.png" alt=""></a>
                        </div>
                        <!--Single Brand End-->
                        <!--Single Brand Start-->
                        <div class="single-brand img-full">
                            <a href="#"><img src="/web/img/brand/brand3.png" alt=""></a>
                        </div>
                        <!--Single Brand End-->
                        <!--Single Brand Start-->
                        <div class="single-brand img-full">
                            <a href="#"><img src="/web/img/brand/brand4.png" alt=""></a>
                        </div>
                        <!--Single Brand End-->
                        <!--Single Brand Start-->
                        <div class="single-brand img-full">
                            <a href="#"><img src="/web/img/brand/brand5.png" alt=""></a>
                        </div>
                        <!--Single Brand End-->
                        <!--Single Brand Start-->
                        <div class="single-brand img-full">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="single-footer-widget mb-30">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="/web/img/logo/logo-footer.png" alt=""></a>
                                </div>
                            </div>
                            <!--Single Footer Widget End-->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="footer-payments-image">
                                <img src="/web/img/payment/payment-icon.png" alt="">
                            </div>
                            <!--Footer Payment End-->
                            <!--Footer Menu Start-->
                            ...
                            <div class="tab-content product-details-large" id="myTabContent">
                                <div class="tab-pane fade show active" id="single-slide1" role="tabpanel" aria-labelledby="single-slide-tab-1">
                                    ...
                                    <div class="single-product-img img-full">
                                        <img src="/web/img/single-product/large/single-product1.jpg" alt="">
                                    </div>
                                ...
                                <div class="tab-pane fade" id="single-slide2" role="tabpanel" aria-labelledby="single-slide-tab-2">
                                    <!--Single Product Image Start-->
                                    <div class="single-product-img img-full">
                                        <img src="/web/img/single-product/large/single-product2.jpg" alt="">
                                    </div>
                                    <!--Single Product Image End-->
                                </div>
                                <div class="tab-pane fade" id="single-slide3" role="tabpanel" aria-labelledby="single-slide-tab-3">
                                    <!--Single Product Image Start-->
                                    <div class="single-product-img img-full">
                                        <img src="/web/img/single-product/large/single-product3.jpg" alt="">
                                    </div>
                                    <!--Single Product Image End-->
                                </div>
                                <div class="tab-pane fade" id="single-slide4" role="tabpanel" aria-labelledby="single-slide-tab-4">
                                    <!--Single Product Image Start-->
                                    <div class="single-product-img img-full">
                                        <img src="/web/img/single-product/large/single-product4.jpg" alt="">
                                    </div>
                                    <!--Single Product Image End-->
                                </div>
                                <div class="tab-pane fade" id="single-slide5" role="tabpanel" aria-labelledby="single-slide-tab-4">
                                    <!--Single Product Image Start-->
                                    <div class="single-product-img img-full">
                                        <img src="/web/img/single-product/large/single-product5.jpg" alt="">
                                    </div>
                                    <!--Single Product Image End-->
                                </div>
                                <div class="tab-pane fade" id="single-slide6" role="tabpanel" aria-labelledby="single-slide-tab-4">
                                    <!--Single Product Image Start-->
                                    <div class="single-product-img img-full">
                                        <img src="/web/img/single-product/large/single-product6.jpg" alt="">
                                    </div>
                                    <!--Single Product Image End-->
                                </div>
                            </div>
                            ...
                            <div class="single-product-menu">
                                <div class="nav single-slide-menu owl-carousel" role="tablist">
                                    <div class="single-tab-menu img-full">
                                        <a class="active" data-toggle="tab" id="single-slide-tab-1" href="#single-slide1"><img src="/web/img/single-product/small/single-product1.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-toggle="tab" id="single-slide-tab-2" href="#single-slide2"><img src="/web/img/single-product/small/single-product2.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-toggle="tab" id="single-slide-tab-3" href="#single-slide3"><img src="/web/img/single-product/small/single-product3.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-toggle="tab" id="single-slide-tab-4" href="#single-slide4"><img src="/web/img/single-product/small/single-product4.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-toggle="tab" id="single-slide-tab-5" href="#single-slide5"><img src="/web/img/single-product/small/single-product5.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-toggle="tab" id="single-slide-tab-6" href="#single-slide6"><img src="/web/img/single-product/small/single-product6.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!--Modal Tab Menu End-->
...
<!--Easyzoom-->
<script src="/web/js/easyzoom.min.js"></script>
<!--Nice Select-->
...
<!--Venobox-->
<script src="/web/js/venobox.min.js"></script>
<!--Jquery Ui-->
...
<!-- Mirrored from d29u17ylf1ylz9.cloudfront.net/plantmore-v3/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Aug 2018 17:25:23 GMT -->
</html>
