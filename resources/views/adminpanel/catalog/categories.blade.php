        ...
        <div class="content">
            <div class="content-header">
                ...
                <div class="header-title">
                    ...
                    <button id="cancelCategoryButton" style="display: none;" type="button" class="btn btn-base w-md m-rb-5"><span class="glyphicon glyphicon-remove"></span> Cancel New Category</button>
                    <ol class="breadcrumb">
