...
(function(factory) {
  ...
  Markdown.prototype = {
    ...
    showEditor: function() {
      ...
      if (this.$editor === null) {
        ...
        var editorFooter = $('<div/>', {
            'class': 'md-footer.blade.php'
          }),
          createFooter = false,
          footer = '';
        // Create the footer.blade.php if savable
        if (options.savable) {
          createFooter = true;
    ...
    showPreview: function() {
      ...
      if (afterContainer && afterContainer.attr('class') === 'md-footer.blade.php') {
        // If there is footer.blade.php element, insert the preview container before it
